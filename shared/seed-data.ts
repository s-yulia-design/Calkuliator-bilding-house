import type { TemplateSeed } from './types.ts';

/** Объёмы типового проекта ИЖД 001. Цены = 0, заполняются в настройках цен / смете. */
export const nigmetovaTemplate: TemplateSeed = {
  id: '001',
  name: 'ИЖД 001 (шаблон)',
  description: '1 этаж ~74 м², застройка ~96 м². Типовые объёмы для сметы.',
  stages: [
    {
      name: 'Фундамент',
      items: [
    ...
    {
      name: 'Инженерные системы и отделка',
      items: [
        { name: 'Электрика (кабель, автоматы, розетки, щит)', unit: 'компл.', qty: 1, note: 'уточнить по проекту' },
        { name: 'Отопление (котёл / радиаторы / трубы)', unit: 'компл.', qty: 1, note: 'уточнить по проекту' },
        { name: 'Штукатурка внутренних стен', unit: 'м²', qty: 0, note: 'уточнить площадь' },
        { name: 'Штукатурка потолков', unit: 'м²', qty: 0, note: 'уточнить площадь' },
        { name: 'Стяжка / выравнивание пола', unit: 'м²', qty: 74, note: 'по отапливаемой площади' },
      ],
    },
  ],
};
...
export const defaultCatalog: Array<{
  ...
  { name: 'Электрика комплектом', unit: 'компл.', materialPrice: 180000, laborPrice: 120000 },
  { name: 'Отопление комплектом', unit: 'компл.', materialPrice: 250000, laborPrice: 150000 },
  { name: 'Штукатурка стен', unit: 'м²', materialPrice: 250, laborPrice: 450 },
  { name: 'Стяжка пола', unit: 'м²', materialPrice: 400, laborPrice: 350 },
];
